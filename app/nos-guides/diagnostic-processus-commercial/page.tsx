...
const sections = [
  { id: "introduction", title: "Votre Défi" },
  { id: "audit-quantitatif", title: "Audit Quantitatif" },
  { id: "audit-qualitatif", title: "Audit Qualitatif" },
  { id: "audit-strategique", title: "Audit Stratégique" },
  { id: "plan-action", title: "Plan d'Action" },
  { id: "cas-client", title: "Cas Client" },
  { id: "prochaine-etape", title: "Prochaine Étape" },
]

export default function DiagnosticPage() {
  return (
    <GuidePageWrapper
      title="Audit Processus Commercial : Diagnostic Complet de votre Organisation"
      description="Le guide pratique pour identifier précisément où votre équipe perd de l'argent et comment y remédier"
      category="SECTION 1 : DIAGNOSTIC"
      sections={sections}
      previousGuide={null}
      nextGuide={{
    ...
    >
      ...
      <section id="introduction" className="mb-16">
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8 mb-6 border-l-4 border-l-[#f4d03f]">
          <p className="mb-4 leading-relaxed">
            Vous le savez au fond de vous : quelque chose cloche dans vos ventes. Vos commerciaux travaillent dur, vos
            produits sont bons, pourtant les résultats stagnent. Pire, vous avez cette sensation désagréable de laisser
            de l'argent sur la table.
          </p>

          <div className="bg-red-50 border-l-4 border-red-500 p-6 mb-4">
            <p className="font-medium text-red-900 leading-relaxed">
              La réalité brutale : 78% des entreprises B2B ne savent pas précisément où elles perdent de l'argent dans
              leur processus commercial. Elles voient les symptômes mais pas les causes racines.
            </p>
          </div>

          <p className="font-medium leading-relaxed">
            Ce guide vous donne la méthode exacte pour diagnostiquer votre organisation commerciale comme un expert et
            identifier vos 3 leviers d'amélioration prioritaires.
          </p>
        </div>
      </section>
      ...
      <section id="audit-quantitatif" className="mb-16">
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8 mb-8 border-l-4 border-l-blue-500">
          <h3 className="text-2xl font-medium mb-4">Niveau 1 : Audit Quantitatif - Les Mathématiques de vos Ventes</h3>
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8 mb-8 border-l-4 border-l-orange-500">
          ...
          <div className="space-y-6">
            ...
            <div className="border-l-4 border-[#d4a574] pl-6">
              ...
              <div className="bg-green-50 border border-green-200 rounded p-4">
                <p className="font-medium text-green-900">Résultats attendus Mois 2 : +20-25% d'amélioration globale</p>
              </div>
            </div>
            ...
            <div className="border-l-4 border-[#d4a574] pl-6">
              ...
              <div className="bg-green-50 border border-green-200 rounded p-4">
                <p className="font-medium text-green-900">Résultats attendus Mois 3 : +30-40% d'amélioration durable</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="prochaine-etape" className="mb-16">
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
          ...
          <p className="mb-8 leading-relaxed">
            Vous avez maintenant tous les outils pour auditer votre processus commercial comme un expert et identifier
            vos leviers d'amélioration prioritaires.
          </p>
      ...
      <div className="mt-8 text-center text-sm text-gray-600">
        <p className="italic leading-relaxed">
          Cette section vous a donné les outils pour diagnostiquer précisément votre organisation commerciale. La
          section suivante vous révèle comment générer un pipeline prévisible avec les techniques de prospection
          moderne.
        </p>
      </div>
    </GuidePageWrapper>
