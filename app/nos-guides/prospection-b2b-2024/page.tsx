...
const sections = [
  { id: "challenge", title: "Votre Défi" },
  { id: "statistics", title: "État de la Prospection 2024" },
  { id: "pillars", title: "3 Piliers de la Prospection Moderne" },
  { id: "cold-calling", title: "Cold Calling 3.0" },
  { id: "social-selling", title: "Social Selling Avancé" },
  { id: "ai-automation", title: "IA et Automation" },
  { id: "multichannel", title: "Orchestration Multicanale" },
  { id: "measurement", title: "Mesure et Optimisation" },
  { id: "implementation", title: "Plan d'Implémentation 90 Jours" },
  { id: "case-study", title: "Cas Client" },
]

export default function ProspectionPage() {
  return (
    <GuidePageWrapper
      title={`Prospection B2B ${getCurrentYear()} : Comment Générer un Pipeline Prévisible`}
      description="Le guide complet des techniques de prospection modernes qui fonctionnent vraiment"
      category="SECTION 2 : PROSPECTION"
      sections={sections}
      previousGuide={{
        href: "/nos-guides/diagnostic-processus-commercial",
        title: "Diagnostic et Fondamentaux",
      }}
      nextGuide={{
        href: "/nos-guides/meddpicc-guide-complet",
        title: "Qualification MEDDPICC",
      }}
    >
      {/* Challenge section */}
      <div
      ...
      >
        ...
        <p className="mb-4 leading-relaxed">
          Vos commerciaux passent 60% de leur temps à prospecter mais n'obtiennent que 2-3 RDV par semaine ? Vous n'êtes
          pas seuls. La prospection B2B a radicalement changé :
        </p>
        ...
        <p className="mt-4 leading-relaxed">
          <strong>Ce guide vous révèle leurs méthodes exactes</strong> pour transformer votre prospection en machine à
          pipeline prévisible.
        </p>
      </div>
      ...
      <div id="cold-calling" className="bg-white rounded-lg border border-gray-200 p-8 mb-12">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          ...
          <p className="leading-relaxed">
            Vos commerciaux font 50 appels/jour mais n'obtiennent que 2-3 contacts utiles ? Le problème n'est pas la
            quantité, c'est la méthode.
          </p>
          <p className="font-medium mt-3">
            L'approche moderne du cold calling combine préparation intelligente, structure conversationnelle et valeur
            immédiate.
          </p>
        </div>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="bg-white rounded p-3 font-mono text-sm">
              ...
              <br />
              Cela semble pertinent pour [Entreprise prospect] ?"
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <div className="bg-gray-50 rounded p-3 font-mono text-sm">
              ...
              <br />
              <br />
              Cela vous intéresserait-il de découvrir comment adapter votre approche
              <br />
      ...
      <div id="social-selling" className="bg-white rounded-lg border border-gray-200 p-8 mb-12">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          <h3 className="text-xl font-medium mb-3">🎯 Votre Défi de Management</h3>
          <p className="leading-relaxed">
            87% de vos commerciaux utilisent LinkedIn, mais seulement 23% génèrent des RDV qualifiés via ce canal. Le
            problème ? Ils appliquent des méthodes obsolètes sur une plateforme qui a évolué.
          </p>
        </div>
      ...
      <div id="ai-automation" className="bg-white rounded-lg border border-gray-200 p-8 mb-12">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          <h3 className="text-xl font-medium mb-3">🎯 Votre Défi de Management</h3>
          <p className="leading-relaxed">
            Vos commerciaux passent 3h/jour sur des tâches répétitives (recherche prospects, rédaction emails, suivi) au
            lieu de vendre. L'IA peut automatiser 70% de ces tâches.
          </p>
        </div>
      ...
      <div id="multichannel" className="bg-white rounded-lg border border-gray-200 p-8 mb-12">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          <h3 className="text-xl font-medium mb-3">🎯 Votre Défi de Management</h3>
          <p className="leading-relaxed">
            Vos commerciaux utilisent email OU téléphone OU LinkedIn, mais rarement les 3 de manière coordonnée.
            L'orchestration multicanale peut augmenter vos taux de réponse de 300%.
          </p>
        </div>
      ...
      {/* Measurement and Optimization section */}
      <div id="measurement" className="bg-white rounded-lg border border-gray-200 p-8 mb-12">
        <h2 className="text-2xl font-medium mb-6">📈 Mesure et Optimisation Continue</h2>

        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          <h3 className="text-xl font-medium mb-3">🎯 Votre Défi de Management</h3>
          <p className="leading-relaxed">
            Vos commerciaux prospectent mais vous ne savez pas vraiment ce qui fonctionne ? 73% des directeurs
            commerciaux ne mesurent pas précisément l'efficacité de leur prospection. Sans mesure, impossible
            d'optimiser.
          </p>
          <p className="font-medium mt-3">
            Les équipes performantes mesurent 15+ KPIs et optimisent chaque semaine. Voici comment faire pareil.
          </p>
        </div>

        <h3 className="text-xl font-medium mb-4">📊 Dashboard de Prospection : Les KPIs Essentiels</h3>

        <h4 className="text-lg font-medium mb-3">NIVEAU 1 : Métriques d'Activité (Mesure quotidienne)</h4>
        <div className="overflow-x-auto mb-6">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-gray-50">
                <th className="border border-gray-200 p-3 text-left">KPI</th>
                <th className="border border-gray-200 p-3 text-left">Définition</th>
                <th className="border border-gray-200 p-3 text-left">Benchmark</th>
                <th className="border border-gray-200 p-3 text-left">Alerte si</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Emails envoyés</td>
                <td className="border border-gray-200 p-3">Nombre d'emails prospection/jour</td>
                <td className="border border-gray-200 p-3">40-60/jour</td>
                <td className="border border-gray-200 p-3 text-red-600">&lt; 30/jour</td>
              </tr>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Appels passés</td>
                <td className="border border-gray-200 p-3">Nombre d'appels tentés/jour</td>
                <td className="border border-gray-200 p-3">30-50/jour</td>
                <td className="border border-gray-200 p-3 text-red-600">&lt; 20/jour</td>
              </tr>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Connexions LinkedIn</td>
                <td className="border border-gray-200 p-3">Demandes envoyées/semaine</td>
                <td className="border border-gray-200 p-3">25-40/semaine</td>
                <td className="border border-gray-200 p-3 text-red-600">&lt; 15/semaine</td>
              </tr>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Temps prospection</td>
                <td className="border border-gray-200 p-3">Heures dédiées/jour</td>
                <td className="border border-gray-200 p-3">3-4h/jour</td>
                <td className="border border-gray-200 p-3 text-red-600">&lt; 2h/jour</td>
              </tr>
            </tbody>
          </table>
        </div>

        <h4 className="text-lg font-medium mb-3">NIVEAU 2 : Métriques d'Efficacité (Mesure hebdomadaire)</h4>
        <div className="overflow-x-auto mb-6">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-gray-50">
                <th className="border border-gray-200 p-3 text-left">KPI</th>
                <th className="border border-gray-200 p-3 text-left">Formule</th>
                <th className="border border-gray-200 p-3 text-left">Benchmark</th>
                <th className="border border-gray-200 p-3 text-left">Excellence</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Taux d'ouverture email</td>
                <td className="border border-gray-200 p-3">Emails ouverts / Emails envoyés</td>
                <td className="border border-gray-200 p-3">35-45%</td>
                <td className="border border-gray-200 p-3 text-green-600">&gt; 55%</td>
              </tr>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Taux de réponse email</td>
                <td className="border border-gray-200 p-3">Réponses / Emails envoyés</td>
                <td className="border border-gray-200 p-3">8-12%</td>
                <td className="border border-gray-200 p-3 text-green-600">&gt; 18%</td>
              </tr>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Taux de contact téléphone</td>
                <td className="border border-gray-200 p-3">Contacts / Appels tentés</td>
                <td className="border border-gray-200 p-3">15-25%</td>
                <td className="border border-gray-200 p-3 text-green-600">&gt; 30%</td>
              </tr>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Taux conversion RDV</td>
                <td className="border border-gray-200 p-3">RDV obtenus / Contacts</td>
                <td className="border border-gray-200 p-3">20-30%</td>
                <td className="border border-gray-200 p-3 text-green-600">&gt; 40%</td>
              </tr>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Taux acceptation LinkedIn</td>
                <td className="border border-gray-200 p-3">Acceptées / Demandes envoyées</td>
                <td className="border border-gray-200 p-3">30-40%</td>
                <td className="border border-gray-200 p-3 text-green-600">&gt; 50%</td>
              </tr>
            </tbody>
          </table>
        </div>

        <h4 className="text-lg font-medium mb-3">NIVEAU 3 : Métriques Business (Mesure mensuelle)</h4>
        <div className="overflow-x-auto mb-6">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-gray-50">
            ...
            <tbody>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">RDV qualifiés/commercial</td>
                <td className="border border-gray-200 p-3">RDV qualifiés / Mois</td>
                <td className="border border-gray-200 p-3">20-30/mois</td>
                <td className="border border-gray-200 p-3">Pipeline prévisible</td>
              </tr>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Coût par RDV</td>
                <td className="border border-gray-200 p-3">(Salaire + Outils) / RDV obtenus</td>
                <td className="border border-gray-200 p-3">80-150€</td>
                <td className="border border-gray-200 p-3">Rentabilité prospection</td>
              </tr>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Taux conversion RDV→Opps</td>
                <td className="border border-gray-200 p-3">Opportunités / RDV</td>
                <td className="border border-gray-200 p-3">40-60%</td>
                <td className="border border-gray-200 p-3">Qualité prospection</td>
              </tr>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">Pipeline généré</td>
                <td className="border border-gray-200 p-3">Valeur opportunités créées</td>
                <td className="border border-gray-200 p-3">3-5x quota</td>
                <td className="border border-gray-200 p-3">Atteinte objectifs</td>
              </tr>
              <tr>
                <td className="border border-gray-200 p-3 font-medium">ROI prospection</td>
                <td className="border border-gray-200 p-3">CA généré / Coût prospection</td>
                <td className="border border-gray-200 p-3">5:1 à 8:1</td>
                <td className="border border-gray-200 p-3">Performance globale</td>
              </tr>
            </tbody>
          </table>
        </div>

        <h3 className="text-xl font-medium mb-4 mt-8">🔬 Méthodologie d'Optimisation A/B Testing</h3>

        <div className="bg-gray-50 rounded-lg p-6 mb-6">
          <h4 className="text-lg font-medium mb-4">Framework de Test Systématique</h4>

          <div className="space-y-6">
            <div className="border-l-4 border-purple-500 pl-4">
              <h5 className="font-medium mb-2">ÉTAPE 1 : Identifier les Variables à Tester</h5>
              <div className="space-y-3 text-sm">
                <div>
                  <p className="font-medium">Emails :</p>
                  <ul className="list-disc pl-6 space-y-1 text-gray-700">
                    <li>Objets (longueur, personnalisation, question vs affirmation)</li>
                    <li>Structure (AIDA vs PAS vs BAB)</li>
                    <li>Longueur (court &lt;100 mots vs long &gt;200 mots)</li>
                    <li>CTA (direct vs soft, question vs proposition)</li>
                    <li>Timing d'envoi (matin vs après-midi, jour de semaine)</li>
                  </ul>
                </div>
                <div>
                  <p className="font-medium">Cold Calls :</p>
                  <ul className="list-disc pl-6 space-y-1 text-gray-700">
                    <li>Accroche (personnalisée vs générique)</li>
                    <li>Durée pitch (15s vs 30s vs 45s)</li>
                    <li>Type de preuve (chiffres vs témoignage vs cas client)</li>
                    <li>Horaires d'appel (8h-10h vs 14h-16h vs 17h-19h)</li>
                  </ul>
                </div>
                <div>
                  <p className="font-medium">LinkedIn :</p>
                  <ul className="list-disc pl-6 space-y-1 text-gray-700">
                    <li>Message connexion (avec vs sans note)</li>
                    <li>Premier message (valeur vs question vs ressource)</li>
                    <li>Fréquence posts (3x vs 5x par semaine)</li>
                    <li>Type contenu (conseil vs cas client vs personnel)</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              <h5 className="font-medium mb-2">ÉTAPE 2 : Protocole de Test Rigoureux</h5>
              <div className="bg-white rounded p-4 space-y-2 text-sm">
                <p>
                  <strong>Taille échantillon :</strong> Minimum 100 prospects par variante
                </p>
                <p>
                  <strong>Durée test :</strong> 2-4 semaines selon volume
                </p>
                <p>
                  <strong>Segmentation :</strong> Répartition aléatoire 50/50
                </p>
                <p>
                  <strong>Variable unique :</strong> Ne tester qu'un élément à la fois
                </p>
                <p>
                  <strong>Mesure :</strong> Définir métrique de succès avant le test
                </p>
              </div>
            </div>

            <div className="border-l-4 border-purple-500 pl-4">
              <h5 className="font-medium mb-2">ÉTAPE 3 : Analyse et Décision </h5>
              <div className="bg-white rounded p-4 text-sm">
                <p className="mb-2 font-medium">Critères de validation :</p>
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
                  <li>
                    <strong>Amélioration &gt; 20%</strong> : Déployer immédiatement
                  </li>
                  <li>
                    <strong>Amélioration 10-20%</strong> : Tester sur échantillon plus large
                  </li>
                  <li>
                    <strong>Amélioration &lt; 10%</strong> : Continuer version actuelle
                  </li>
                  <li>
                    <strong>Dégradation</strong> : Abandonner et analyser pourquoi
                  </li>
                </ul>
              </div>
            </div>
        ...
        <h3 className="text-xl font-medium mb-4 mt-8">📋 Exemple Concret : Test Objet Email</h3>

        <div className="grid md:grid-cols-2 gap-6 mb-6">
          <div className="border border-gray-200 rounded-lg p-4">
            <h4 className="font-medium mb-3 text-red-600">VERSION A (Contrôle)</h4>
            <div className="bg-gray-50 rounded p-3 mb-3">
              <p className="text-sm font-mono">"Optimiser votre prospection B2B"</p>
            </div>
            <div className="space-y-2 text-sm">
              <p>
                <strong>Échantillon :</strong> 150 prospects
              </p>
              <p>
                <strong>Taux d'ouverture :</strong> 32%
              </p>
              <p>
                <strong>Taux de réponse :</strong> 8%
              </p>
              <p>
                <strong>RDV obtenus :</strong> 4 (2,7%)
              </p>
            </div>
          </div>

          <div className="border border-green-200 rounded-lg p-4 bg-green-50">
            <h4 className="font-medium mb-3 text-green-600">VERSION B (Test)</h4>
            <div className="bg-white rounded p-3 mb-3">
              <p className="text-sm font-mono">"[Prénom], +40% de RDV en 90j ?"</p>
            </div>
            <div className="space-y-2 text-sm">
              <p>
                <strong>Échantillon :</strong> 150 prospects
              ...
              <p>
                <strong>Taux d'ouverture :</strong> 51% (+59%)
              </p>
              <p>
                <strong>Taux de réponse :</strong> 14% (+75%)
              </p>
              <p>
                <strong>RDV obtenus :</strong> 9 (6%) (+123%)
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-green-100 border border-green-300 rounded-lg p-4 mb-6">
          <p className="font-medium text-green-800 mb-2">✅ DÉCISION : Déployer Version B</p>
          <p className="text-sm text-green-700">
            Amélioration significative sur tous les KPIs. La personnalisation + chiffre concret + question génère 2x
            plus de RDV. Déploiement immédiat sur toutes les campagnes.
          </p>
        </div>

        <h3 className="text-xl font-medium mb-4 mt-8">🎯 Routine d'Optimisation Hebdomadaire</h3>

        <div className="bg-gray-50 rounded-lg p-6">
          <h4 className="text-lg font-medium mb-4">Checklist Manager Commercial (30 min/semaine)</h4>

          <div className="space-y-4">
            <div className="bg-white rounded-lg p-4">
              <h5 className="font-medium mb-2">LUNDI : Analyse Performance Semaine Précédente</h5>
              <ul className="space-y-1 text-sm">
                <li>☐ Extraire les KPIs de chaque commercial (activité + efficacité)</li>
                <li>☐ Identifier les 3 meilleurs et 3 moins bons performers</li>
                <li>☐ Analyser les écarts : pourquoi certains performent mieux ?</li>
                <li>☐ Préparer les points de coaching individuels</li>
              </ul>
            </div>

            <div className="bg-white rounded-lg p-4">
              <h5 className="font-medium mb-2">MERCREDI : Coaching et Ajustements </h5>
              <ul className="space-y-1 text-sm">
                <li>☐ Session 15 min avec chaque commercial sous-performant</li>
                <li>☐ Partager les best practices des top performers</li>
                <li>☐ Ajuster les templates/scripts si nécessaire</li>
                <li>☐ Lancer un nouveau test A/B si opportunité identifiée</li>
              </ul>
            </div>

            <div className="bg-white rounded-lg p-4">
              <h5 className="font-medium mb-2">VENDREDI : Planification Semaine Suivante</h5>
              <ul className="space-y-1 text-sm">
                <li>☐ Définir les objectifs d'activité par commercial</li>
                <li>☐ Valider les listes de prospects à contacter</li>
                <li>☐ Préparer les ressources nécessaires (templates, contenus)</li>
                <li>☐ Communiquer les priorités et focus de la semaine</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
          <p className="text-sm">
            <strong>💡 Règle d'Or :</strong> Une équipe qui mesure et optimise chaque semaine améliore ses résultats de
            5-10% par mois. Sur un an, c'est une multiplication par 2-3 de la performance.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg border-2 border-amber-300 p-8 mb-12">
        ...
        <p className="text-lg mb-6 leading-relaxed">
          Vous avez maintenant toutes les méthodes pour transformer votre prospection en machine à pipeline prévisible.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg border border-amber-300 p-6">
            ...
            <p className="text-xs text-center mt-2 text-gray-600">Résultat moyen : +150% de RDV générés en 90 jours</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-8 mb-12">
        ...
        <p className="mt-6 font-medium text-center">
          Cette section transforme la prospection de corvée en science exacte, avec tous les outils pour générer un
          pipeline prévisible. 🎯
        </p>
      </div>
    </GuidePageWrapper>
