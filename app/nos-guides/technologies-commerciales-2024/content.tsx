...
import { CheckCircle2, TrendingUp, Target, Zap, Award, Cpu, BarChart3 } from "lucide-react"
import { getCurrentYear, getLastUpdateDate } from "@/lib/date-utils"

export function TechnologiesClientPage() {
  const currentYear = getCurrentYear()
  const lastUpdate = getLastUpdateDate()

  const sections = [
    { id: "defi", title: "Votre Défi" },
    { id: "paysage", title: "Le Paysage Tech Commercial" },
    { id: "stack", title: "Le Stack Technologique Essentiel" },
    { id: "ia-generative", title: "L'IA Générative" },
    { id: "framework", title: "Framework de Déploiement Tech" },
    { id: "kpis", title: "KPIs Tech à Suivre" },
  ...
  return (
    <GuidePageWrapper
      title={`Technologies Commerciales ${currentYear} : Comment Multiplier la Performance de Votre Équipe`}
      subtitle="Le guide complet pour choisir et déployer les bons outils qui transforment vraiment vos résultats"
      category="SECTION 5 : TECHNOLOGIES & PERFORMANCE"
      sections={sections}
      previousGuide={{
    ...
    >
      ...
      <div
        id="defi"
        className="bg-white rounded-lg border border-gray-200 shadow-sm p-8 mb-16 border-l-4 border-l-[#f4d03f]"
      >
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          <strong>vos commerciaux n'utilisent que 30% des fonctionnalités</strong> et les résultats ne sont pas au
          rendez-vous ?
        </p>
        <p className="text-gray-700 mb-4 leading-relaxed">
        ...
        <p className="text-gray-700 leading-relaxed">
          <strong>Ce guide vous révèle leur stack exact</strong> et comment le déployer pour des résultats mesurables.
        </p>
      </div>

      {/* Tech Landscape */}
      <div id="paysage" className="bg-white rounded-lg border border-gray-200 p-8 mb-8">
        ...
        <div className="overflow-x-auto mb-6">
          <table className="w-full border-collapse">
            ...
            <tbody>
              <tr>
                <td className="border border-gray-200 px-4 py-2 font-medium text-sm">Nombre d'outils sales tech</td>
              ...
              <tr className="bg-gray-50">
                <td className="border border-gray-200 px-4 py-2 font-medium text-sm">Budget tech moyen/commercial</td>
              ...
              <tr>
                <td className="border border-gray-200 px-4 py-2 font-medium text-sm">Taux d'adoption moyen</td>
                ...
                <td className="border border-gray-200 px-4 py-2 text-center text-red-600 font-medium text-sm">-29%</td>
              </tr>
              <tr className="bg-gray-50">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            Plus d'outils disponibles, budgets en hausse, ROI potentiel énorme... mais adoption en chute libre.
      ...
      {/* Essential Stack */}
      <div id="stack" className="bg-white rounded-lg border border-gray-200 p-8 mb-8">
        ...
        <p className="text-gray-700 mb-6 leading-relaxed">
          Voici les 5 catégories d'outils indispensables pour une équipe commerciale performante en {currentYear} :
        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="border-l-4 border-[#d4a574] pl-4">
            <h3 className="text-xl font-medium mb-2">3. Intelligence Conversationnelle : Améliorer les Calls</h3>
            <p className="text-gray-700 mb-3 leading-relaxed">
      ...
      {/* AI Revolution */}
      <div id="ia-generative" className="bg-white rounded-lg border border-gray-200 p-8 mb-8">
        <h2 className="text-2xl font-medium mb-6 flex items-center gap-2">
        ...
        <div className="space-y-4">
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="bg-white rounded p-3 font-mono text-xs mb-2">
              "Analyse cette entreprise [URL LinkedIn] et identifie : 1) Leurs 3 principaux défis business 2) Les
              décideurs clés à contacter 3) Les signaux d'achat potentiels 4) Un angle d'approche personnalisé"
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="bg-white rounded p-3 font-mono text-xs mb-2">
              "Rédige un email de prospection pour [Prénom] [Nom], [Poste] chez [Entreprise]. Contexte : [pain point
              identifié]. Ton : professionnel mais chaleureux. Objectif : obtenir un call de 15 min. Max 100 mots."
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="bg-white rounded p-3 font-mono text-xs mb-2">
              "Je vais appeler [Prénom] [Nom], [Poste] chez [Entreprise]. Voici ce que je sais : [contexte]. Génère : 1)
              5 questions de découverte pertinentes 2) 3 objections probables et leurs réponses 3) Un pitch d'accroche
              de 30 secondes"
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="bg-white rounded p-3 font-mono text-xs mb-2">
              "Analyse cette transcription d'appel commercial : [coller transcription]. Identifie : 1) Les pain points
              exprimés 2) Les signaux d'achat 3) Les objections soulevées 4) Les next steps recommandés 5) Le score
              MEDDPICC (1-10 par critère)"
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="bg-white rounded p-3 font-mono text-xs mb-2">
              "Rédige une proposition commerciale pour [Client]. Contexte : [pain points, budget, timeline]. Notre
              solution : [description]. Structure : 1) Executive Summary 2) Problématique 3) Solution proposée 4) ROI
              attendu 5) Timeline 6) Pricing. Ton : professionnel et orienté résultats."
            </div>
      ...
      <div id="framework" className="bg-white rounded-lg border border-gray-200 p-8 mb-8">
        <h2 className="text-2xl font-medium mb-6 flex items-center gap-2">
        ...
        <p className="text-gray-700 mb-6 leading-relaxed">
          La clé du succès n'est pas d'avoir les meilleurs outils, mais de les déployer correctement. Voici le framework
          en 4 phases :
        </p>
      ...
      {/* KPIs */}
      <div id="kpis" className="bg-white rounded-lg border border-gray-200 p-8 mb-8">
        <h2 className="text-2xl font-medium mb-6 flex items-center gap-2">
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            Créez un dashboard unique qui centralise tous ces KPIs et le partagez en transparence avec l'équipe. La
            visibilité des métriques augmente l'adoption de 40%.
          </p>
        </div>
      </div>

      {/* Case Study */}
      <div id="cas-client" className="bg-white rounded-lg border border-gray-200 p-8 mb-8">
        <h2 className="text-2xl font-medium mb-6 flex items-center gap-2">
      ...
      <div
        id="prochaine-etape"
        className="bg-gradient-to-br from-[#d4a574] to-[#c49563] text-white rounded-lg p-8 mb-8"
      >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white/10 backdrop-blur rounded-lg p-6">
            ...
            <p className="text-xs text-center mt-2 text-white/80">Résultat moyen : +40% de productivité en 90 jours</p>
          </div>
        </div>
      </div>

      {/* Removed Navigation as it's now part of GuidePageWrapper */}
    </GuidePageWrapper>
  )
}
